...
public class ControllerGun {
     ...
     *
     * Prioridade:
     * 1. Se o Bullet Shield estiver habilitado pela DefenseStrategyManager e houver uma
     *    bala inimiga perigosa, tentar interceptá-la.
     * 2. Caso contrário (escudo em fallback por falhas recentes, ou sem onda válida),
     *    usar o ataque normal contra o robô inimigo.
     */
    ...
    private boolean tentarBulletShield() {
        ...
        // Attempting shield this tick — this counts for success/efficiency metrics.
